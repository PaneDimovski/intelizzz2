...
public class LivePresenter implements LiveContract.Presenter, DatePickerDialog.OnDateSetListener {
...
//    private final SimpleDateFormat sdf_month = new SimpleDateFormat("");
    ...
    public LivePresenter(IntelizzzRepository repository, LiveContract.View view) {
